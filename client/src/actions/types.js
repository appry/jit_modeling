...
export const UPDATE_ELEMENT_PRODUCT = "UPDATE_ELEMENT_PRODUCT";
export const CREATE_ELEMENT_PRODUCT = "CREATE_ELEMENT_PRODUCT";
export const DELETE_ELEMENT_PRODUCT = "DELETE_ELEMENT_PRODUCT";

export const OPTIMISE = "OPTIMISE";
